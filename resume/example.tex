...
\section{Experience}
    \resumeSubHeadingListStart
        ...
        \resumeSubheading
            ...
            {TU Munich}{Munich, Germany}
            \resumeItemListStart
                \resumeItem{Guided 20+ students in developing low-level FreeRTOS applications in C targeted for embedded systems. }
...
\section{Projects}
    ...
    \resumeSubHeadingListStart
        ...
        \vspace{-16pt}
        \resumeProjectHeading
            {\href{https://github.com/duclos-cavalcanti/Open-MPI-ValueIteration}{\textbf{Open-MPI Value Iteration}} $|$ \emph{C++, Parallel-Computing, MPI, HPC}}{\small{Mar 2021}}
            \resumeItemListStart
