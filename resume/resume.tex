...
\tagline{American Citizen -- Electrical and Computer Engineer -- Born in MN, Living in NY}
...
\end{itemize}
The work builds upon the current desire to migrate financial exchanges to the public cloud. 
Although the benefits are notable, the lack of an available cloud-native multicast mechanism still inhibits said shift.
...
\cvevent{Research Assistant}{EDA Department - TU Munich}{Jul '22 -- Oct '22}{Munich, GER}
...
\cvtag{Golang}\cvtag{Lua}\cvtag{Rust}\cvtag{JavaScript}\\
