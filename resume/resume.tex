...
\section{Experience}
    \resumeSubHeadingListStart
        \resumeSubheading
            {Research Assistant}{Jul 22 -- Oct 22}
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    ...
    \textbf{Technologies}{: Cloud Computing, Computer Networking, Embedded Systems, FPGA, RTOS, Machine Learning, HPC} \\
    \textbf{Frameworks}{: ZeroMQ, DPDK, Tensorflow, TFLite, Numpy, Pandas, OpenMPI, OpenMP, Xilinx Vivado} \\
    \textbf{Protocols}{: TCP, UDP, IP, USB, UART} \\
