...
\section{Projects}
    \resumeSubHeadingListStart
        \resumeProjectHeading
            ...
            \resumeItemListEnd
        \resumeProjectHeading
            {\href{https://github.com/duclos-cavalcanti/microsemi-error-detection}{\textbf{Hamming Code Error Detection (16,11)}} $|$ \emph{C, VHDL, FPGA, SoC, UART}}{\small{2022 -- 2023}}
            \resumeItemListStart
        ...
        \resumeProjectHeading
            ...
            \resumeItemListStart
              ...
              \resumeItem{Prototype that uses MPI techniques to iteratively distribute workload across an HPC cluster and gather results.}
            \resumeItemListEnd
        % \resumeProjectHeading
