...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    ...
    \textbf{Tools}{: Linux, Git, Github CI/CD, Jenkins, Unix Shell, CMake, Vim, VSCode} \\
    \textbf{Technologies}{: Docker, ZeroMQ, DPDK, MPI, Packer, Vagrant, Tensorflow, Scipy, NumPy, Pandas} \\
