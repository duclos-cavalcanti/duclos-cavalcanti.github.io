    ...
    \resumeSubHeadingListStart
        \resumeSubheading
            ...
            \resumeItemListStart
                ...
                \resumeItem{Evaluated the performance of multiple ML models across GPUs, CPUs and TPUs with TensorFlow Lite.}
        ...
        \resumeSubheading
            ...
            \resumeItemListStart
                \resumeItem{Added unit-tests (GTest) and test coverage (lcov) to safety critical features of the team's motor embedded controller.}
                \resumeItem{Developed tooling for state simulations of the team's electric motor via Linux's virtual CAN interface and mock APIs.}
                \resumeItem{Extended the firmware update system used by 18+ clients, consisting of partial updates via CAN bus.}
        ...
        \resumeSubheading
            ...
            {TU Munich}{Munich, Germany}
            \resumeItemListStart
                \resumeItem{Mentored over 10 students in developing low-level FreeRTOS applications in C for embedded systems.}
