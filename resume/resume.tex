...
\cvsection{Education}
    ...
    \cvevent{Visiting Graduate Student (Non-Degree)}
        {New York University, Courant Institute of Mathematical Sciences}
        {Sept 2023 -- Aug/Sept 2024}{New York, USA}
\begin{itemize}
\item Research Work - Selection Heuristic for Financial Exch. the Cloud    
...
\cvsection{Certificates \& Languages}
\begin{center}
...
\cvtag{Unix}\cvtag{Bash}\cvtag{CMake}\cvtag{GNU Make}\cvtag{Git}\\
