...
\section{Projects}
    \resumeSubHeadingListStart
        \resumeProjectHeading
            {\href{https://github.com/duclos-cavalcanti/TreeBuilder}{\textbf{Cloud-TreeBuilder}} $|$ \emph{GCP, Terraform, Python, C++, Distributed Systems, Heuristic}}{\small{Mar 2024 -- Present}}
            \resumeItemListStart
            ...
            \resumeItemListEnd
        \resumeProjectHeading
            {\href{https://github.com/duclos-cavalcanti/microsemi-error-detection}{\textbf{Hamming Code Error Detection}} $|$ \emph{C, VHDL, FPGA, SoC}}{\small{2022 -- 2023}}
            \resumeItemListStart
              ...
              \resumeItem{Microprocessor offloads error-injected data onto the FPGA fabric for correction via an APB3 Bus Matrix.}
            \resumeItemListEnd
        \resumeProjectHeading
    ...
    \resumeSubHeadingListStart
        \resumeProjectHeading
          ...
          \resumeItemListStart
                ...
                \resumeItem{Used kernel-bypass techniques (DPDK) to scale and achieve $\sim$\% lower latency than AWS's multicast service.}
          \resumeItemListEnd
    \resumeSubHeadingListEnd
