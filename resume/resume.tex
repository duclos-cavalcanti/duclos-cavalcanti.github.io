...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    ...
    \textbf{Cloud Services}{: Google Cloud Platform (GCP), Amazon EC2 (AWS), Terraform, Packer} \\
    \textbf{Tools}{: Linux, Git, Github CI/CD, Jenkins, Unix Shell, CMake, GNU Make, Bazel, Vim, VSCode} \\
    \textbf{Technologies}{: Docker, ZeroMQ, TCP, UDP, DPDK, Tensorflow, Scipy, NumPy, Pandas, MPI, FPGA} \\
