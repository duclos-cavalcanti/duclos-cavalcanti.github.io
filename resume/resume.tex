...
\section{Education}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
        ...
        \resumeItemListStart
            %\resumeItem{M.Sc. Thesis: \textbf{VM Selection Heuristic for Multicast Overlay Trees in the Cloud}}
            %\resumeItem{Visiting Non-Degree Graduate Student: \textbf{New York University} -- \textbf{GPA 4.0}}
            %\resumeItem{Co-Authored Publication: \href{https://arxiv.org/abs/2402.09527}{Design and Implementation of A Scalable Financial Exchange in the Cloud}}
            \resumeItem{Master Thesis: \textbf{VM Selection Heuristic for Financial Exchanges in the Cloud}}
...
\section{Experience}
    \resumeSubHeadingListStart
        ...
        \resumeSubheading
            ...
            {TU Munich}{Munich, Germany}
            \resumeItemListStart
                \resumeItem{Mentored over 20 students in developing low-level FreeRTOS applications in C for embedded systems.}
                \resumeItem{Taught software engineering best practices, focusing on concurrency, real-time scheduling, and performance optimization.}
            \resumeItemListEnd
    \resumeSubHeadingListEnd 
    ...
    \resumeSubHeadingListStart
        ...
        \resumeProjectHeading
            ...
            \resumeItemListStart
              ...
              \resumeItem{Used different MPI techniques to iteratively distribute workload across an HPC cluster and gather results.}
