    ...
    \resumeSubHeadingListStart
        \resumeSubheading
            ...
            \resumeItemListStart
                ...
                \resumeItem{Established that over 60\% of total inference time consists of data transmission with the external TPU.}
...
\section{Projects}
    ...
    \resumeSubHeadingListStart
        \resumeProjectHeading
            ...
            \resumeItem{Integrated Terraform for cloud state management, ZMQ for node communication, and Protobufs for data serialization.}
