...
\tagline{American Citizen -- Electrical and Computer Engineer -- Living in NY}
...
\cvtag{C/C++}\cvtag{Linux}\cvtag{Embedded Systems}
\cvtag{Python}\cvtag{FreeRTOS}\cvtag{IoT}\cvtag{VHDL}\cvtag{FPGAs}
\cvtag{Distributed Systems}\cvtag{AWS}\cvtag{GCP}\cvtag{Cloud}
\cvtag{Unix}\cvtag{Bash}\cvtag{CMake}\cvtag{Docker}\cvtag{Git}\\
\cvtag{Computer Networking}\cvtag{Operating Systems}\\
\cvtag{High-Perf. Computing}\cvtag{OpenMP}\cvtag{OpenMPI}
\cvtag{ZeroMQ}\cvtag{TCP/UDP/IP}\cvtag{DPDK}
\cvtag{Tensorflow}\cvtag{TFLite}\cvtag{TinyML}
\cvtag{CI/CD}\cvtag{Jenkins}\cvtag{GoogleTest}
