...
\begin{center}
    ...
    \textbf{\large{\scshape Computer Engineer -- English, German, \& Portuguese}} \\ \vspace{1pt}
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    ...
    \textbf{Technologies}{: Cloud Computing, Computer Networking, Machine Learning, TCP, UDP, IP, FPGA, RTOS, IoT, HPC} \\
    \textbf{Frameworks}{: ZeroMQ, DPDK, Tensorflow, TFLite, Numpy, Pandas, OpenMPI, OpenMP} \\
    ...
    \resumeSubHeadingListStart
        ...
        \resumeSubheading
            ...
            \resumeItemListStart
                ...
                \resumeItem{Automated build and testing workflows via Jenkins and CMake for a team of over 10 engineers.}
            \resumeItemListEnd
            \vspace{2.0pt}
...
\section{Projects}
    \resumeSubHeadingListStart
        \resumeProjectHeading
            {\textbf{Cloud TreeFinder} $|$ \emph{GCP, Terraform, Python, C++, Distributed Systems, ZMQ, Protobufs}}{\small{March 2024 -- Present}}
            \resumeItemListStart
              \resumeItem{Launches a cloud cluster and forms from it's pool of \textbf{N} VMs an optimal multicast tree of depth \textbf{D} and fanout \textbf{F}.}
