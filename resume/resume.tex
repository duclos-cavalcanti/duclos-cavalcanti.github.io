    ...
    \resumeSubHeadingListStart
        \resumeSubheading
            ...
            \resumeItemListStart
                ...
                \resumeItem{TensorDSE used reports to accelerate a model's inference/deployment optimally onto available hardware devices.}
            \resumeItemListEnd
        ...
        \resumeSubheading
            ...
            \resumeItemListStart
                \resumeItem{Added unit-tests (GTest) and test coverage (lcov) to safety critical features of their motor's embedded controller.}
                ...
                \resumeItem{Extended their firmware update system used by 18+ clients, consisting of partial updates via CAN bus.}
        ...
        \resumeSubheading
            ...
            {TU Munich}{Munich, Germany}
            \resumeItemListStart
                \resumeItem{Guided 20+ students in developing performant low-level FreeRTOS applications in C. }
                \resumeItem{Provided feedback on concurrency, real-time scheduling, correctness, and software engineering best practices.}
            \resumeItemListEnd
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
        ...
        \resumeItemListStart
            ...
            \resumeItem{\small{\textbf{Related Coursework}: Machine Learning Methods, Computer Networks, High Performance Computing Lab}}
            %\resumeItem{\small{\textbf{Related Coursework}: Machine Learning Methods, Embedded Design for ML, High Performance Computing Lab}}
        \resumeItemListEnd
