...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
    \textbf{Languages}{: C, C++, Python, Golang, Rust, Bash, JavaScript, HTML/CSS, Lua, VHDL, Tcl} \\
...
\section{Projects}
    \resumeSubHeadingListStart
        \resumeProjectHeading
            ...
            \resumeItemListStart
              \resumeItem{Launches a cloud cluster and from it's pool of \textbf{N} VMs \textbf{forms} an optimal multicast tree of depth \textbf{D} and fanout \textbf{F}.}
