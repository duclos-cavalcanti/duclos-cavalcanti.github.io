...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    ...
    \textbf{Technologies}{: Docker, ZeroMQ, DPDK, MPI, FPGA, IoT, TensorFlow, Scipy, NumPy, Pandas, OpenMP} \\
...
\section{Projects}
    \resumeSubHeadingListStart
        \resumeProjectHeading
            ...
            \resumeItemListStart
              \resumeItem{Launches and selects VMs out of a pool cluster (N) to create an optimal multicast tree of depth D and fan-out F.}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
        ...
        \resumeItemListStart
            ...
            \resumeItem{\textbf{Related Coursework}: Machine Learning Methods and Tools, Computer Networks, Secure SoC for IoT,\\Embedded Design for Machine Learning, High Performance Computing for Machine Intelligence}
        \resumeItemListEnd
