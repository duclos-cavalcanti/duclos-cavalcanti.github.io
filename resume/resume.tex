...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    ...
    \textbf{Technologies}{: Docker, ZeroMQ, DPDK, MPI, FPGA, IoT, TensorFlow, Scipy, NumPy, Pandas} \\
    ...
    \resumeSubHeadingListStart
        \resumeProjectHeading
            ...
            \resumeItemListStart
              ...
              \resumeItem{Deploys UDP based probe jobs on randomly selected node subsets, collecting and processing results (JSON). }
