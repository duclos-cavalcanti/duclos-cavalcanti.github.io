...
\section{Publications}
    ...
    \resumeSubHeadingListStart
            ...
            \resumeItemListStart
                ...
                \resumeItem{\textbf{Kernel-bypass} datapath (\textbf{DPDK}) sustaining \textbf{175K multicast msgs/sec} at $\sim$\textbf{50\% lower latency} than AWS multicast.}
                \resumeItem{Cited by researchers and engineers from Jane Street, Google and Microsoft Research.}
...
\section{Projects}
    ...
    \resumeSubHeadingListStart
        \resumeProjectHeading
            ...
            % \resumeItem{Mitigates \textbf{straggler VMs} by probing cluster network performance to build a multicast tree of depth D, fan-out F. r}
            \resumeItem{Mitigates \textbf{straggler VMs} by probing cluster network performance to build a multicast tree of depth D, fan-out F. Ranks candidate VMs by weighted \textbf{p90 one-way delay} and standard deviation from UDP probes}
            % \resumeItem{Ranks candidate VMs by weighted \textbf{p90 one-way delay} and standard deviation from UDP probes.}
            \resumeItem{Custom heuristic matches \textbf{LemonDrop}'s \textbf{NP-hard QAP} optimizer on a 25-VM cluster: \textbf{7.7\% lower p90} and \textbf{10.6\% lower median} worst-receiver latency at a fraction of the compute.}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
        ...
        \resumeItemListStart
            ...
            \resumeItem{M.Sc. Thesis: VM Selection Heuristic for Financial Exchanges in the Cloud}
            \resumeItem{Visiting Graduate Student: \textbf{New York University} (2023 -- 2024) -- Operating Systems Coursework, Research}
