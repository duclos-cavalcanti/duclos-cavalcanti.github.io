...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    ...
    \textbf{Tools}{: Linux, Terraform, Google Cloud (GCP), AWS, Docker, Packer, Git, Unix Shell, Bazel, CMake, Vim, VSCode} \\
    \textbf{Frameworks}{: ZeroMQ, DPDK, MPI, OpenMP, Tensorflow, Scipy, Numpy, Pandas, Jenkins, Github Workflows, Ansible} \\
    ...
    \resumeSubHeadingListStart
        ...
        \resumeProjectHeading
            ...
            \resumeItemListStart
              ...
              \resumeItem{Leveraged different OpenMPI techniques to distribute workloads across an HPC cluster and gather results.}
            \resumeItemListEnd
        % \resumeProjectHeading
...
\section{Education}
  \resumeSubHeadingListStart
    ...
    %         \resumeItem{\textbf{Related Coursework}: Machine Learning Methods and Tools, Embedded Design for Machine Learning, \\Chips Multicore Processors, Computer Networking, High Performance Computing for Machine Intelligence}
    %     \resumeItemListEnd
